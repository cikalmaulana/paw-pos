...
import OrderMain from "./_element/order.main";
import { doGetOngoingOrderList } from "./_function/do.getOngoingOrderList";
...
export default function OrderPage() {
    ...
    const starterData = async () => {
        ...
        if (stored) {
            try {
                ...
                const orderList = await doGetOngoingOrderList(datas.store.id)
    ...
    return (
        <View className="flex-1 mt-24 min-h-screen">
