...
interface I_Props{
    addCatModalOpen: boolean
    newCategoryName: string
    newCategoryNameWarn: string
    cancelEdit:()=>void
    saveAddCategory:()=>void
...
export default function CategoryAddNew(props: I_Props) {
    const { width, height } = Dimensions.get("window");
    
    return (
        <Modal
            visible={props.addCatModalOpen}
            transparent
            animationType="fade"
            ...
            <Pressable onPress={props.cancelEdit} className="flex-1 bg-black/50 justify-center items-center px-6">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Text className="text-xl text-primary font-bold mb-4">Add Category</Text>
                            ...
                            <View className="flex flex-col justify-center gap-4 mb-4">
                                ...
                                />
                                {props.newCategoryNameWarn !== '' && (
                                    <Text className="text-danger -mt-3">
                                        {props.newCategoryNameWarn}
                                    </Text>
                                )}
                            </View>
